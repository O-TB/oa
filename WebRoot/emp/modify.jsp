...
<body>
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
		...
		<c:if test="${role != '管理员' }">
			<tr>
				<td align="left" id="main-left">
					<a href="#" target="mainFrame" onFocus="this.blur()" class="edit">编辑个人信息</a>
					<a href="http://localhost:8080/oa/emp/show.do" target="mainFrame" onFocus="this.blur()"
						class="return">返回</a>
				</td>
			</tr>
		</c:if>
		<c:if test="${role eq '管理员' }">
			<tr>
				<td align="left" id="main-left">
					<a href="#" target="mainFrame" onFocus="this.blur()" class="edit">编辑员工信息</a>
					<a href="http://localhost:8080/oa/emp/show.do" target="mainFrame" onFocus="this.blur()"
						class="return">返回</a>
				</td>
			</tr>
		...
		<tr>
			<td align="left" valign="top">
				<form name="f1" method="post" action="<%=path%>/emp/update.do">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
						<c:if test="${role eq '管理员' }">
							<tr onMouseOut="this.style.backgroundColor='#ffffff'"
								...
								<td align="left" valign="middle" class="borderright borderbottom main-for">
									<input id="empno" type="text" name="empno" value="${record.empno}" class="text-word"
										onmouseout="out1()">
								</td>
							</tr>
						</c:if>
						...
						<c:if test="${role!='管理员' }">
							<tr onMouseOut="this.style.backgroundColor='#ffffff'"
								...
								<td align="left" valign="middle" class="borderright borderbottom main-for">
									<input type="text" name="name" value="${record.name}" class="text-word">
								</td>
							</tr>
						</c:if>
						<c:if test="${role eq '管理员' }">
							<tr onMouseOut="this.style.backgroundColor='#ffffff'"
								...
								<td align="right" valign="middle" class="borderright borderbottom bggray">姓名：</td>
								<td align="left" valign="middle" class="borderright borderbottom main-for">
									<input type="text" name="name" value="${record.name}" class="text-word" readonly="readonly">
								</td>
							</tr>
						</c:if>
						...
						<c:if test="${role eq '管理员' }">
							<tr onMouseOut="this.style.backgroundColor='#ffffff'"
								...
								<td align="right" valign="middle" class="borderright borderbottom bggray">性别：</td>
								<td align="left" valign="middle" class="borderright borderbottom main-for">
									<input type="text" name="sex" value="${record.sex}" class="text-word" readonly="readonly">
								</td>
							</tr>
						...
						<c:if test="${role!='管理员' }">
							<tr onMouseOut="this.style.backgroundColor='#ffffff'"
								...
								<td align="left" valign="middle" class="borderright borderbottom main-for">
									<input type="text" id="tel" name="tel" value="${record.tel}" class="text-word"
										onmouseout="out2()">
								</td>
							</tr>
						</c:if>
						...
						<c:if test="${role!='管理员' }">
							<tr onMouseOut="this.style.backgroundColor='#ffffff'"
								...
								<td align="left" valign="middle" class="borderright borderbottom main-for">
									<input type="text" id="mail" name="mail" value="${record.mail}" class="text-word"
										onmouseout="out3()">
								</td>
							</tr>
						</c:if>
						<c:if test="${role eq '管理员' }">
							<input type="hidden" name="mail" value="${record.mail }" />
						</c:if>
						...
						<c:if test="${role!='管理员' }">
							<tr onMouseOut="this.style.backgroundColor='#ffffff'"
								...
								<td align="left" valign="middle" class="borderright borderbottom main-for">
									<input type="text" name="birth" id="birth" value="${record.birth}" class="text-word"
										onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" />
								</td>
							</tr>
						</c:if>
						<c:if test="${role eq '管理员' }">
							<input type="hidden" name="birth" value="${record.birth }" />
						</c:if>
						...
						<c:if test="${role eq '管理员' }">
							<tr onMouseOut="this.style.backgroundColor='#ffffff'"
								...
								<td align="left" valign="middle" class="borderright borderbottom main-for">
									<input type="text" name="empTime" id="empTime" value="${record.empTime}" class="text-word"
										onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" />
								</td>
							</tr>
						</c:if>
						<c:if test="${role!='管理员' }">
							<input type="hidden" name="empTime" value="${record.empTime }" />
						</c:if>
						<c:if test="${role eq '管理员' }">
							<tr onMouseOut="this.style.backgroundColor='#ffffff'"
								onMouseOver="this.style.backgroundColor='#edf5ff'">
								...
								<td align="left" valign="middle" class="borderright borderbottom main-for">
									<select name="dept">
										<c:forEach var="data" items="${deptList }">
											<option ${data.name eq record.dept?"selected":"" }>${data.name }</option>
										</c:forEach>
									</select>
								</td>
							</tr>
						...
						<c:if test="${role!='管理员' }">
							<input type="hidden" name="dept" value="${record.dept }" />
						</c:if>
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="left" valign="middle" class="borderright borderbottom main-for">
								<input type="password" name="pwd" value="${record.pwd}" class="text-word" />
							</td>
						</tr>
							...
							<tr onMouseOut="this.style.backgroundColor='#ffffff'"
								...
								<td align="left" valign="middle" class="borderright borderbottom main-for">
									<select name="state" id="state">
										<option ${record.state eq '普通员工'?"selected":"" }>普通员工</option>
										<option ${record.state eq '主任'?"selected":"" }>主任</option>
									</select>
								</td>
							</tr>
						</c:if>
						<c:if test="${role!='管理员' }">
							<input type="hidden" name="state" value="${record.state }" />
						</c:if>
