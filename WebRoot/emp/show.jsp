		...
		<c:if test="${role eq '管理员' }">
			<tr>
				<td align="left" valign="top" id="addinfo">
					<a href="#" target="mainFrame" onFocus="this.blur()" class="add">员工信息</a>
				</td>
			</tr>
		</c:if>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
					...
					<c:forEach var="data" items="${all }">
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="center" valign="middle" class="borderright borderbottom">${data.birth }</td>
							...
							<td align="center" valign="middle" class="borderright borderbottom">${data.empTime }</td>
							...
							<td align="center" valign="middle" class="borderbottom">
								...
								<a href="<%=path %>/emp/findById.do?id=${data.id}" target="mainFrame" onFocus="this.blur()"
									class="add">编辑</a>

								<c:if test="${role eq '管理员' }">

									<span class="gray">&nbsp;|&nbsp;</span>
									<a href="<%=path %>/emp/del.do?id=${data.id}" target="mainFrame" onFocus="this.blur()"
