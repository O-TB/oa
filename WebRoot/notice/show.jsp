	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
		...
		<tr>
			<td align="left" valign="top" id="addinfo">
				<a href="#" target="mainFrame" onFocus="this.blur()" class="add">公告信息</a>
			</td>
		</tr>
		<tr>
					...
					<c:forEach var="data" items="${all }">
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="center" valign="middle" class="borderright borderbottom">
								<fmt:formatDate value="${data[2] }" pattern="yyyy-MM-dd" />
							</td>


							<c:if test="${role eq '管理员' }">
								<td align="center" valign="middle" class="borderbottom">
									<a href="<%=path %>/notice/findById.do?id=${data[0]}" target="mainFrame"
										onFocus="this.blur()" class="add">修改</a>
									<span class="gray">&nbsp;|&nbsp;</span>
									<a href="<%=path %>/notice/del.do?id=${data[0]}" target="mainFrame" onFocus="this.blur()"
