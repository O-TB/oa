	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td align="left" valign="top" id="addinfo"><a href="#"
				target="mainFrame" onFocus="this.blur()" class="add">数据添加</a></td>
		</tr>
		<tr>
			<td align="left" valign="top">
				<form method="post" action="<%=path%>/offs/add.do">
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="left" valign="middle"
								...
								type="text" name="empno" value="${loginUser[1] }" class="text-word" readonly="readonly">
							</td>
						</tr>
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="left" valign="middle"
								class="borderright borderbottom main-for"><input
								type="text" name="name" value="${loginUser[2] }" class="text-word" readonly="readonly">
							</td>
						</tr>
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="left" valign="middle"
								class="borderright borderbottom main-for"><input
								type="text" name="offDate" value="" class="text-word"
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="left" valign="middle"
								class="borderright borderbottom main-for"><input
								type="text" name="offTime" value="" class="text-word" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});">
							</td>
						</tr>
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for"><textarea name="reason" cols="" rows=""></textarea></td>
      </tr>
