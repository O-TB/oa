	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
		<tr>
			<td align="left" valign="top" id="addinfo">
				<a href="#" target="mainFrame" onFocus="this.blur()" class="add">考勤信息</a>
			</td>
		</tr>
		<tr>
			...
			<td align="left" valign="top">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
					<tr>
						...
						<th align="center" valign="middle" class="borderright">上班时间</th>
						<th align="center" valign="middle" class="borderright">下班时间</th>
						<th align="center" valign="middle" class="borderright">考勤日期</th>
					...
					<c:forEach var="data" items="${all }">
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="center" valign="middle" class="borderright borderbottom start" >${data.start }</td>
							<td align="center" valign="middle" class="borderright borderbottom over" >${data.over }</td>
							<td align="center" valign="middle" class="borderright borderbottom">
								<fmt:formatDate value="${data.dutyDate }" pattern="yyyy-MM-dd" />
							</td>
							<c:if test="${role eq '主任' }">
								<td align="center" valign="middle" class="borderbottom">
									<a href="<%=path %>/duty/findById.do?id=${data.id}" target="mainFrame"
										onFocus="this.blur()" class="add">编辑</a>
									<span class="gray">&nbsp;|&nbsp;</span>
									<a href="<%=path %>/duty/del.do?id=${data.id}" target="mainFrame" onFocus="this.blur()"
