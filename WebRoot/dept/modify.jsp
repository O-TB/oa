	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
		...
		<tr>
			<td align="left" id="main-left">
				<a href="#" target="mainFrame" onFocus="this.blur()" class="edit">编辑部门信息</a>
				<a href="http://localhost:8080/oa/dept/show.do" target="mainFrame" onFocus="this.blur()" class="return">返回</a>
			</td>
		</tr>
		<tr>
			<td align="left" valign="top">
				<form name="f1" method="post" action="<%=path%>/dept/update.do">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
						...
						<c:if test="${role eq '主任' }">
							<tr onMouseOut="this.style.backgroundColor='#ffffff'"
								...
								<td align="left" valign="middle" class="borderright borderbottom main-for">
									<input type="text" name="name" value="${record.name }" readonly="readonly"
										class="text-word">
								</td>
							</tr>
						</c:if>
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							onMouseOver="this.style.backgroundColor='#edf5ff'">
							<td align="right" valign="middle" class="borderright borderbottom bggray">部门描述：</td>
							<td align="left" valign="middle" class="borderright borderbottom main-for">
								<textarea name="manager" cols="" rows="">${record.manager}</textarea>
							</td>
						</tr>
