	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
		...
		<tr>
			<td align="left" id="main-left">
				<a href="#" target="mainFrame" onFocus="this.blur()" class="edit">修改我的文档</a>
				<a href="http://localhost:8080/oa/report/showmy.do" target="mainFrame" onFocus="this.blur()" class="return">返回</a>
			</td>
		</tr>
		<tr>
			<td align="left" valign="top">
				<form name="f1" method="post" action="<%=path%>/report/update.do" enctype="multipart/form-data">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							onMouseOver="this.style.backgroundColor='#edf5ff'">
							<td align="right" valign="middle" class="borderright borderbottom bggray">文档描述 ：</td>
							<td align="left" valign="middle" class="borderright borderbottom main-for">
								<input type="text" name="title" value="${record[3] }" class="text-word">
							</td>
						</tr>

						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							onMouseOver="this.style.backgroundColor='#edf5ff'">
							<td align="right" valign="middle" class="borderright borderbottom bggray">文档资料：</td>
							<td align="left" valign="middle" class="borderright borderbottom main-for">
