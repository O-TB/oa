	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td align="left" id="main-left">
				<a href="#" target="mainFrame" onFocus="this.blur()" class="edit">修改薪资信息</a>
				<a href="http://localhost:8080/oa/wages/show.do" target="mainFrame" onFocus="this.blur()" class="return">返回</a>
			</td>
		</tr>
		<tr>
			<td align="left" valign="top">
				<form id="form1" method="post" action="<%=path%>/wages/update.do">
				   <input type="hidden" name="id" value="${record.id }"/>
				   <input type="hidden" name="publish" value="${record.publish}"/>
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="left" valign="middle"
								...
								readonly="readonly" class="text-word"></td>
						</tr>
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							onMouseOver="this.style.backgroundColor='#edf5ff'">
							<td align="right" valign="middle"
								class="borderright borderbottom bggray">提成：</td>
							<td align="left" valign="middle"
								class="borderright borderbottom main-for"><input
								type="text" name="perf" value="${record.perf }" class="text-word"
									id="perf" onmouseout="out1()"></td>
						</tr>

						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							onMouseOver="this.style.backgroundColor='#edf5ff'">
							<td align="right" valign="middle"
								class="borderright borderbottom bggray">工资：</td>
							<td align="left" valign="middle"
								class="borderright borderbottom main-for"><input
								type="text" name="base" value="${record.base}" class="text-word" 
									id="base" onmouseout="out2()"></td>
						</tr>
							...
							<td align="left" valign="middle"
								...
								type="submit" onMouseDown="check();" value="提交" class="text-but"> <input
