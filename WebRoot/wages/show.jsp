	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
		<tr>
			<td align="left" valign="top" id="addinfo">
				<a href="#" target="mainFrame" onFocus="this.blur()" class="add">薪资信息</a>
			</td>
		</tr>
		<tr>
			...
			<td align="left" valign="top">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
					<tr>
						...
						<th align="center" valign="middle" class="borderright">工资</th>
						<th align="center" valign="middle" class="borderright">提交日期</th>
						<c:if test="${deptName eq '办公室' }">
					...
					<c:forEach var="data" items="${all }">
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="center" valign="middle" class="borderright borderbottom">${data.perf }</td>
							<td align="center" valign="middle" class="borderright borderbottom">${data.base }</td>
							<td align="center" valign="middle" class="borderright borderbottom">
								<fmt:formatDate value="${data.curtime }" pattern="yyyy-MM-dd" />
							</td>
							<c:if test="${deptName eq '办公室' }">
								<td align="center" valign="middle" class="borderbottom">
									<a href="<%=path %>/wages/findById.do?id=${data.id}" target="mainFrame"
										onFocus="this.blur()" class="add">修改</a>
									<span class="gray">&nbsp;|&nbsp;</span>
									<a href="<%=path %>/wages/del.do?id=${data.id}" target="mainFrame" onFocus="this.blur()"
