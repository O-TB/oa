...
<tr>
				<td align="left" valign="top" id="addinfo">
					<a href="#" target="mainFrame" onFocus="this.blur()" class="add">异常信息</a>
				</td>
			</tr>
		<tr>
			...
			<td align="left" valign="top">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<th align="center" valign="middle" class="borderright">异常日期</th>
						<th align="center" valign="middle" class="borderright">异常描述</th>
					...
					<c:forEach var="data" items="${all }">
						<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
							...
							<td align="center" valign="middle" class="borderright borderbottom">${data.workDate }</td>
							...
							<a href="<%=path %>/works/findById.do?id=${data.id}" target="mainFrame" onFocus="this.blur()" class="add">修改</a><span class="gray">&nbsp;|&nbsp;</span>
							</c:if>
							 <a href="<%=path %>/works/del.do?id=${data.id}" target="mainFrame" onFocus="this.blur()" class="add" onClick="return fun()">删除</a>
							 <c:if test="${role eq '主任' }">
							  <span class="gray">&nbsp;|&nbsp;</span> 
							  <a href="<%=path %>/works/yes.do?id=${data.id}" target="mainFrame" onFocus="this.blur()" class="add">通过</a><span class="gray">&nbsp;|&nbsp;</span>
							  <a href="<%=path %>/works/no.do?id=${data.id}" target="mainFrame" onFocus="this.blur()" class="add">驳回</a>
							 </c:if>
						    </td>
						</tr>
					</c:forEach>
