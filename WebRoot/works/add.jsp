	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td align="left" valign="top" id="addinfo"><a href="#"
				target="mainFrame" onFocus="this.blur()" class="add">异常提交</a></td>
		</tr>
		<tr>
			<td align="left" valign="top">
				<form name="f1" method="post" action="<%=path%>/works/add.do">
				    <input type="hidden" name="publish" value="${deptName }"/>
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="left" valign="middle"
								...
								<input type="text" name="empno" value="${loginUser[1] }" class="text-word" readonly="readonly">
						    </td>
						</tr>
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="left" valign="middle"
								class="borderright borderbottom main-for">
								<input type="text" name="name" value="${loginUser[2] }" class="text-word" readonly="readonly">
							</td>
						</tr>
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							onMouseOver="this.style.backgroundColor='#edf5ff'">
							<td align="right" valign="middle"
								class="borderright borderbottom bggray">异常日期：</td>
							<td align="left" valign="middle"
								class="borderright borderbottom main-for">
								<input type="text" name="workDate" id="workDate" value="" class="text-word" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});"/></td>
						</tr>
