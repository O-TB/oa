	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td align="left" valign="top" id="addinfo"><a href="#"
				target="mainFrame" onFocus="this.blur()" class="add">提交申请</a>
			</td>
		</tr>
		<tr>
			<td align="left" valign="top">
				<form name="f1" method="post" action="<%=path%>/apply/add.do">
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							onMouseOver="this.style.backgroundColor='#edf5ff'">
							<td align="right" valign="middle"
								class="borderright borderbottom bggray">申请描述：</td>
							<td align="left" valign="middle"
								class="borderright borderbottom main-for"><textarea name="title"
									cols="" rows=""></textarea>
							</td>
						</tr>		
