	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
		<tr>
			<td align="left" valign="top" id="addinfo">
				<a href="#" target="mainFrame" onFocus="this.blur()" class="add">申请信息</a>
			</td>
		</tr>
		<tr>
			...
			<td align="left" valign="top">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
					<tr>
						...
						<th align="center" valign="middle" class="borderright">申请描述</th>
					...
					<c:forEach var="data" items="${all }">
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="center" valign="middle" class="borderright borderbottom">
								<fmt:formatDate value="${data[4] }" pattern="yyyy-MM-dd" />
							</td>
							<td align="center" valign="middle" class="borderright borderbottom">${data[6]}</td>
							<td align="center" valign="middle" class="borderbottom">
								<c:if test="${role eq '普通员工' }">
									<a href="<%=path %>/apply/findById.do?id=${data[0]}" target="mainFrame"
										onFocus="this.blur()" class="add">修改</a>
									<span class="gray">&nbsp;|&nbsp;</span>
								</c:if>
								<a href="<%=path %>/apply/del.do?id=${data[0]}" target="mainFrame" onFocus="this.blur()"
									class="add" onClick="return fun()">删除</a>
								<c:if test="${role eq '主任' }">
									<span class="gray">&nbsp;|&nbsp;</span>
									<a href="<%=path %>/apply/yes.do?id=${data[0]}" target="mainFrame" onFocus="this.blur()"
										class="add">通过</a>
									<span class="gray">&nbsp;|&nbsp;</span>
									<a href="<%=path %>/apply/no.do?id=${data[0]}" target="mainFrame" onFocus="this.blur()"
										class="add">驳回</a>
								</c:if>
							</td>
						</tr>
