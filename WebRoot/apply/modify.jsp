	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
		...
		<tr>
			<td align="left" id="main-left">
				<a href="#" target="mainFrame" onFocus="this.blur()" class="edit">修改申请信息</a>
				<a href="http://localhost:8080/oa/apply/show.do" target="mainFrame" onFocus="this.blur()" class="return">返回</a>
			</td>
		</tr>
		<tr>
			<td align="left" valign="top">
				<form name="f1" method="post" action="<%=path%>/apply/update.do">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							onMouseOver="this.style.backgroundColor='#edf5ff'">
							<td align="right" valign="middle" class="borderright borderbottom bggray">申请描述：</td>
							<td align="left" valign="middle" class="borderright borderbottom main-for">
								<textarea name="title" cols="" rows="">${data[3] }</textarea>
							</td>
						</tr>
						<!-- <tr onMouseOut="this.style.backgroundColor='#ffffff'"
							onMouseOver="this.style.backgroundColor='#edf5ff'">
						...
						<tr onMouseOut="this.style.backgroundColor='#ffffff'"
							...
							<td align="left" valign="middle" class="borderright borderbottom main-for">
								<input name="" type="submit" onMouseDown="check();" value="提交" class="text-but">
